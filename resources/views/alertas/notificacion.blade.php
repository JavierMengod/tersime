                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @if ($tg)
                            ...
                            <form method="POST" action="{{ route('notifications.destroy', 'telegram') }}"
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @if ($smtp)
                            ...
                            <form method="POST" action="{{ route('notifications.destroy', 'email') }}"
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @if ($dc)
                            ...
                            <form method="POST" action="{{ route('notifications.destroy', 'discord') }}"
